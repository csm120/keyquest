...
- **Status:** ✅ Perfect sync (uses Menu class)
...
- **Status:** ✅ Fixed and synchronized (added phonetic alphabet to visual)
...
- **Status:** ✅ Perfect sync (all games inherit from BaseGame)
...
- **Status:** ✅ Perfect sync (uses dialog_manager)
...
|-------|---------|-------|--------|
| Dark | FG (main text) | 21.00:1 | ✅ AAA |
| Dark | ACCENT (hints) | 14.62:1 | ✅ AAA |
| Dark | HILITE (selected) | 5.77:1 | ✅ AA (FIXED) |
| Light | FG (main text) | 21.00:1 | ✅ AAA |
| Light | ACCENT (hints) | 5.74:1 | ✅ AA |
| Light | HILITE (selected) | 8.59:1 | ✅ AAA |
| High Contrast | All elements | 19-21:1 | ✅ AAA |
...
1. ✅ Fixed dark theme HILITE color contrast (3.52:1 → 4.69:1)
2. ✅ Added phonetic alphabet to lesson intro visual display
3. ✅ Fixed Options menu visual to show all 6 options

### Fixes Applied (2026-02-17)

1. ✅ Added non-color selection markers and visible focus frames across menus/setup views
2. ✅ Added explicit visual typing prompts (`Type now:` / `You typed:`) in tutorial/lesson/test/practice views
3. ✅ Standardized controls hint presentation for consistency
4. ✅ Updated menu/options speech to announce selected state for screen reader parity
